...
public class TestCircleRectangle {
	public static void main(String[] args) {
		...
		System.out.println(object instanceof SimpleGeometricObject);
		System.out.println(circle instanceof CircleFromSimpleGeometricObject);
		System.out.println(object instanceof CircleFromSimpleGeometricObject);
