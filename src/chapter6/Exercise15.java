...
public class Exercise15 {
	public static void main(String[] args) {
		...
		System.out.println("------------------------------------------------------------");
		int start;
		for (start = 50000; start <= 60000; start += 50) {
			System.out.printf("%-12d%-12d%-17d%-12d%-10d\n",start, (int)computeTax(0, (double)start),
					(int)computeTax(1, (double)start), (int)computeTax(2, (double)start),
					(int)computeTax(3, (double)start));
		}
	}
